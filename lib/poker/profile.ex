defmodule Poker.Profile do
  ...
  @archetypes [
    %{name: :calling_station, weight: 20, vpip: 50..70, pfr: 2..8, three_bet: 0..3, fold_to_cbet: 5..20, showdown_curiosity: 80..98, aggression: 5..25, bluff: 0..6, resistance: 10..50, call_too_wide: true, overplays_top_pair: true, chases_draws: true, weird: 10..25, mistakes: 6..14, description: "Paie trop souvent, surtout avec paire ou tirage."},
    %{name: :limp_caller, weight: 15, vpip: 42..62, pfr: 2..10, three_bet: 0..2, fold_to_cbet: 15..35, showdown_curiosity: 65..90, aggression: 5..22, bluff: 0..5, resistance: 10..45, call_too_wide: true, overplays_top_pair: true, chases_draws: true, weird: 12..30, mistakes: 7..15, description: "Limp/call beaucoup et relance peu."},
